...
public class UpdateTourLogic {
     ...
     */
    public boolean updateTourName(String newTourName, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public void updateAdultsNumber(int newAdultsNumber, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public  void updateArrivalCity(String newArrivalCountry, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public  void updateArrivalCountry(String newArrivalCountry, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public void updateArrivalDate(long newArrivalDate, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public void updateChildrenNumber(int newChildrenNumber, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public  void updateDepartureCity(String newDepartureCity, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public  void updateDepartureDate(long newDepartureDate, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public  void updateHotel(String newHotel, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public  void updateNutrition(String newNutrition, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public  void updatePrice(BigDecimal newPrice, int tourId) throws LogicException {
     ...
     * @throws LogicException if handled RepositoryException
     */
    public  void updateStatus(String status, int tourId) throws LogicException {
