...
class ChangeNutritionCommandTest {
    @Mock
    ...
    @InjectMocks
    ChangeNutritionCommand changeNutritionCommand;
    private MockMvc mockMvc;

    @BeforeAll
    void setUp() {
        MockitoAnnotations.initMocks(this);
        mockMvc = MockMvcBuilders.standaloneSetup(changeNutritionCommand)
    ...
    void executeFail() throws Exception {
        when(validation.validateNutrition(anyString())).thenReturn(false);
    ...
    void executeSuccess() throws Exception {
        ...
        mockMvc.perform(post("/change_nutrition")
                ...
                .andExpect(model().attribute(ATTR_NAME_NUTRITION,"nutrition"));
    }
}