...
class ChangeDepartureCityCommandTest {
    @Mock
    ...
    @InjectMocks
    ChangeDepartureCityCommand changeDepartureCityCommand;
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(changeDepartureCityCommand)
    ...
    void executeSuccess() throws Exception {
        ...
        mockMvc.perform(post("/change_departure_city")
                ...
                .andExpect(model().attribute(ATTR_NAME_DEPARTURE_CITY,"city"));
    }
}