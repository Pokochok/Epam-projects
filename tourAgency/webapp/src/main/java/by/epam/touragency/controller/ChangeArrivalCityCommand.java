...
public class ChangeArrivalCityCommand {
    ...
    public ModelAndView execute(
            @RequestParam(value = ParameterConstant.PARAM_NAME_NEW_ARRIVAL_CITY) String newArrivalCountry,
        ...
        updateTourLogic.updateArrivalCity(newArrivalCountry, tourId, tour);
        modelAndView.addObject(ParameterConstant.PARAM_NAME_TOUR_INSTANCE, tour);
        modelAndView.addObject(ParameterConstant.ATTR_NAME_ARRIVAL_CITY, newArrivalCountry);
        return modelAndView;
    }
}
