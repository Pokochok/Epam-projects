...
class ChangeHotelCommandTest {
    ...
    @InjectMocks
    ChangeHotelCommand changeHotelCommand;
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(changeHotelCommand)
    ...
    void executeFail() throws Exception {
        ...
        mockMvc.perform(post("/change_hotel")
                .param(PARAM_NAME_NEW_HOTEL, "hotel")
    ...
    void executeSuccess() throws Exception {
        ...
        doNothing().when(updateTourLogic).updateHotel(anyString(), anyInt(), any());
        mockMvc.perform(post("/change_hotel")
                .param(PARAM_NAME_NEW_HOTEL, "hotel")
                ...
                .andExpect(model().attribute(ATTR_NAME_HOTEL,"hotel"));
    }
}