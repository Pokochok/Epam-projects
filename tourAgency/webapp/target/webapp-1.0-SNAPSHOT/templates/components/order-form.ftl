    ...
    <div class="tourItem">
        ...
        <div class="MinInf">
            ...
            <div class="agentInf">
                ...
                <#if ((order.agent.name!"not defined") != "not defined")>
                    <div>
                        ${order.agent.name!}
                    </div>
                    <div>
        ...
        <div class="orderMore">
            <form method="POST" action="pay_order">
                ...
                <#if (!(order.paymentState!false) && (springSecurity.isClient!false))>
                    <div class="submitMore">
                        <label>
                            <input class="uui-button lime-green transparent" type="submit" value="<@spring.message "clientAgent.orderForm.submit.pay"/>">
                        </label>
                    </div>
                </#if>
            </form>
            ...
            <form  method="post" action="remove_order">
                <#if ((springSecurity.isAgent!false) || (springSecurity.isClient!false))>
                    <a class="uui-button orange" href="remove_order?orderId=${order.id!1}">
